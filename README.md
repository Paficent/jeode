...
Place mods in the `mods/` folder inside your game directory. Each mod is a subfolder with a `manifest.json`, an optional `data` folder for asset overrides, and an optional entry (typically `init.lua`):
